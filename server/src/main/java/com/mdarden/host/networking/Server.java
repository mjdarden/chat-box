package com.mdarden.host.networking;
...
public class Server implements Runnable
{
    ...
    public Server()
    {
        ...
        try
        {
            ...
            props.load(getClass().getResourceAsStream( "/META-INF/server.properties" ));
            String acceptIp = props.getProperty("ip", "127.0.0.1");
            int acceptPort = Integer.parseInt(props.getProperty("port", "10001"));
